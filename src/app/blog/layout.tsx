...
export default function LayoutBlogPost({
    ...
    return (
        <>
            <div className="pointer-events-none fixed left-0 top-0 z-10 h-12 w-full bg-white/10 to-transparent backdrop-blur-xl [-webkit-mask-image:linear-gradient(to_bottom,black,transparent)] dark:bg-zinc-950/10" />
            <ScrollProgress
